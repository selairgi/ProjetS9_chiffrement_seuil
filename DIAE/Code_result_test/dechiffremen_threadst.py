...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan  2 19:20:44 2025
...
if __name__ == "__main__":
    ...
    print(f"=== Simulation de DiAE - Déchiffrement avec reconstruction de clé avec threads ===\n"
          f"n={n}, t={t}\n")
    ...
    for size in file_sizes:
        ...
        for node_count in node_counts:
            ...
            # Simulation du déchiffrement par plusieurs nœuds avec des threads
            total_dec_time_ms = 0
            with concurrent.futures.ThreadPoolExecutor(max_workers=node_count) as executor:
                ...
                for i in range(node_count):
                    ...
                    futures.append(executor.submit(decrypt_simulated, secret_share, node_id))
                
                # Attendre la fin de toutes les tâches et calculer le temps total
                for future in concurrent.futures.as_completed(futures):
                    total_dec_time_ms += future.result()
    ...
    plt.title("Latence moyenne (DiAE Déchiffrement) par nœud et taille de fichier avec threads")
