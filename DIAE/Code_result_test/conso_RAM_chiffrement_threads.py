...
# Simulate distributed encryption process for a file of 32 bytes using threads
def encrypt_32_bytes(n, t):
    ...
    def threaded_eval(share):
        return eval_dprf(share, x)

    with ThreadPoolExecutor() as executor:
        prf_outputs = list(executor.map(threaded_eval, selected_shares))
